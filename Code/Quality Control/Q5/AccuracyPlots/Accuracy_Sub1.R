...
#legend('topleft',
#      legend =c("Cutting","Suturing"), 
#     fill = c("green", "blue"),ncol=1,lty=1:3,cex=0.7)

#Subject1"Time Bar Plot-Cutting Vs Suturing"

#Session 1 

cut1_score<-performance_data$Score.Cut1
sut1_score<-performance_data$Score.Sut1
...
cut2_score<-performance_data$Score.Cut1.1
sut2_score<-performance_data$Score.Sut1.1
...
cut3_score<-performance_data$Score.Cut1.2
sut3_score<-performance_data$Score.Sut1.2
...
cut4_score<-performance_data$Score.Cut1.3
sut4_score<-performance_data$Score.Sut1.3
...
cut5_score<-performance_data$Score.Cut1.4
sut5_score<-performance_data$Score.Sut1.4
...
barplot(t(task.mat),beside=TRUE,main="Subject2",col=c("green","blue"),ylim=c(0,30))
...
task.mat <- as.matrix(task_scores)[,1:2]
barplot(t(task.mat),beside=TRUE,main="Subject3",col=c("green","blue"),ylim=c(0,30))
...
title(main="Accuracy Bar Plot-Cutting Vs Suturing as per Scorer1",outer=T,xlab="Session",ylab="Score")
###########################################################################################################33
