...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject04\\session1")
list.files()

Subject_Session1_Cutting = read.table("Subject04_Cutting1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session1_Surturing = read.table("Subject04_Suturing1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session1_Baseline = read.table("Subject04_Baseline1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
#plot(wZb, type="l", lty=1 ,xlim = c(0,max(Max_Time_B,Max_Time_C,Max_Time_S)), ylim = c(0,max(wZb,wZc,wZs)) ,xlab="Time in seconds", ylab= expression(paste("Perinasal Perspiration [",degree,"C"^2,"]")), main="Subject 4 Session1 Stress Signals", col="black")
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.020) ,xlab=" ", ylab= expression(paste("Perinasal Perspiration [",degree,"C"^2,"]")), main="Session1", col="black")
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject04\\session2")
list.files()

Subject_Session2_Cutting = read.table("Subject04_Cutting2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session2_Surturing = read.table("Subject04_Suturing2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session2_Baseline = read.table("Subject04_Baseline2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.020) ,xlab=" ", ylab= " ", main="Session2", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject04\\session3")
list.files()

Subject_Session3_Cutting = read.table("Subject04_Cutting3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session3_Surturing = read.table("Subject04_Suturing3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session3_Baseline = read.table("Subject04_Baseline3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.020) ,xlab=" ", ylab= expression(paste("Perinasal Perspiration [",degree,"C"^2,"]")), main="Session3", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject04\\session4")
list.files()

Subject_Session4_Cutting = read.table("Subject04_Cutting4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session4_Surturing = read.table("Subject04_Suturing4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session4_Baseline = read.table("Subject04_Baseline4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.020) ,xlab="Time in seconds", ylab= " ", main="Session4", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject04\\session5")
list.files()

Subject_Session5_Cutting = read.table("Subject04_Cutting5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session5_Surturing = read.table("Subject04_Suturing5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session5_Baseline = read.table("Subject04_Baseline5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.020) ,xlab="Time in seconds", ylab= expression(paste("Perinasal Perspiration [",degree,"C"^2,"]")), main="Session5", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
title(main="Subject 4 : Stress Signals",outer=T)