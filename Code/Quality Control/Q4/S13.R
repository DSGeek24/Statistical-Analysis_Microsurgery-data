...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject13\\session1")
list.files()

Subject_Session1_Cutting = read.table("Subject13_Cutting1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session1_Surturing = read.table("Subject13_Suturing1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session1_Baseline = read.table("Subject13_Baseline1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.016) ,xlab=" ", ylab= expression(paste("Perinasal Perspiration [",degree,"C"^2,"]")), main="Session 1", col="black")
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject13\\session2")
list.files()

Subject_Session2_Cutting = read.table("Subject13_Cutting2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session2_Surturing = read.table("Subject13_Suturing2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session2_Baseline = read.table("Subject13_Baseline2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.016) ,xlab=" ", ylab= "", main="Session 2", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject13\\session3")
list.files()

Subject_Session3_Cutting = read.table("Subject13_Cutting3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session3_Surturing = read.table("Subject13_Suturing3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session3_Baseline = read.table("Subject13_Baseline3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.016) ,xlab=" ", ylab= expression(paste("Perinasal Perspiration [",degree,"C"^2,"]")), main="Session 3", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject13\\session4")
list.files()

Subject_Session4_Cutting = read.table("Subject13_Cutting4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session4_Surturing = read.table("Subject13_Suturing4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session4_Baseline = read.table("Subject13_Baseline4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.016) ,xlab="Time in seconds", ylab= " ", main="Session 4", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject13\\session5")
list.files()

Subject_Session5_Cutting = read.table("Subject13_Cutting5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session5_Surturing = read.table("Subject13_Suturing5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session5_Baseline = read.table("Subject13_Baseline5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
plot(wZb, type="l", lty=1 ,xlim = c(0,1250), ylim = c(0,0.016) ,xlab="Time in seconds", ylab= expression(paste("Perinasal Perspiration [",degree,"C"^2,"]")), main="Session 5", col="black")
lines(wZc, type="l", lty=2, col="green") 
lines(wZs, type="l", lty=3, col="red") 
#legend('topright', legend=c("Baseline", "Cutting","Suturing"), col=c("black","green", "red"), lty=1:3, cex=0.8)
...
title(main="Subject 13 : Stress Signals",outer=T)