...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject08\\session1")
list.files()

Subject_Session1_Cutting = read.table("Subject08_Cutting1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session1_Surturing = read.table("Subject08_Suturing1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session1_Baseline = read.table("Subject08_Baseline1.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject08\\session2")
list.files()

Subject_Session2_Cutting = read.table("Subject08_Cutting2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session2_Surturing = read.table("Subject08_Suturing2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session2_Baseline = read.table("Subject08_Baseline2.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject08\\session3")
list.files()

Subject_Session3_Cutting = read.table("Subject08_Cutting3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session3_Surturing = read.table("Subject08_Suturing3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session3_Baseline = read.table("Subject08_Baseline3.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject08\\session4")
list.files()

Subject_Session4_Cutting = read.table("Subject08_Cutting4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session4_Surturing = read.table("Subject08_Suturing4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session4_Baseline = read.table("Subject08_Baseline4.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
setwd("C:\\Users\\MANJU VISVANATHAN\\Desktop\\Stats Project\\subject08\\session5")
list.files()

Subject_Session5_Cutting = read.table("Subject08_Cutting5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session5_Surturing = read.table("Subject08_Suturing5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)

Subject_Session5_Baseline = read.table("Subject08_Baseline5.csv",header = TRUE, sep=",",stringsAsFactors = FALSE)
...
title(main="Subject 8 : Stress Signals",outer=T)